...
load(fullfile(pwd,'ResultsMOTOR_1000perm_100iter.mat'));
...
if saveplots
 ...
 print(gcf,'-dpdf',fullfile(dirdata,'ErrorsConnectomeMotor'));
end
...
if saveplots
 ...
 set(gcf,'PaperOrientation','landscape','PaperPositionMode','auto');
 print(gcf,'-dpdf',fullfile(dirdata,'PowerConnectomeMotor'));
end
...
if saveplots
 ...
 print(gcf,'-dpdf',fullfile(dirdata,'CorrPlotPowerConnectomeMotor'));
end
