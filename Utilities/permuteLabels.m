...
% code to permute the labels within cross-validation. lp is a 3-D array which contains the permuted labels for each split (each page of the array is a different split).
% Four different options are available (see paper)   
